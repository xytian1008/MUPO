...
class AlgorithmConfig:
    ...
    partition_k: int = 2
    """number of clusters for partitioning groups"""
    partition_min: int = 3
    """minimum number of samples per cluster"""
    balance_beta: float = 1.0
    """beta for the load balance scaler"""
    lambda_init: float = 0.4
    """initial lambda for the diversity reward weight"""
    decay_rate: float = 1e-2
    """decay rate for the diversity reward weight"""
